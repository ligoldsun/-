...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey('UserProfile', verbose_name="销售", related_name='customers', blank=True, null=True,default=None )
    ...
    def show_status(self):
        ...
        return '<span style="background-color: {};color: white;padding: 3px" >{}</span>'.format(color_dict.get(self.status),self.get_status_display())
...
class ClassList(models.Model):
    ...
    class Meta:
        unique_together = ("course", "semester", 'campuses')  #地区课程班级联合唯一，北京python17期
    def __str__(self):
